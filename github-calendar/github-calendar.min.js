      ...
      1: [
        function(e, t, r) {
          ...
          t.exports = function(p, e, b) {
            (p = g(p)),
              ((b = b || {}).summary_text =
                ...
                'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' +
                  ...
                  e +
                  "</a>"),
              !1 === b.global_stats && (p.style.minHeight = "175px"),
              (b.proxy =
                b.proxy ||
                function(e) {
            ...
            return (function f() {
              return fetch(
                b.proxy("https://github.com/users/" + e + "/contributions")
              )
                .then(function(e) {
                  return e.text();
                })
                .then(function(e) {
                  ...
                  if (
                    (g(".position-relative h2", r).remove(),
                    ...
                    if (!1 !== b.global_stats) {
                      var s = m(g("svg", r).outerHTML),
                        u = s.current_streak
                          ? y(s.current_streak_range[0], v) +
                            " &ndash; " +
                            y(s.current_streak_range[1], v)
                          : s.last_contributed
                          ? "Last contributed in " +
                            y(s.last_contributed, v) +
                            "."
                          : "Rock - Hard Place",
                        i = s.longest_streak
                          ? y(s.longest_streak_range[0], v) +
                            " &ndash; " +
                            y(s.longest_streak_range[1], v)
                          : s.last_contributed
                          ? "Last contributed in " +
                            y(s.last_contributed, v) +
                            "."
